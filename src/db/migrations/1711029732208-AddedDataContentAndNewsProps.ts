...
export class $npmConfigName1711029732208 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "newsPostContentData" ("id" SERIAL NOT NULL, "type" character varying NOT NULL, "htmlText" character varying NOT NULL, "bgImgSrc" character varying NOT NULL, "translationContentId" integer, CONSTRAINT "PK_bbe58b67d4a310ac786c2dfbf23" PRIMARY KEY ("id"))`,
    )

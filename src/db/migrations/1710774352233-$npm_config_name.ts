...
export class $npmConfigName1710774352233 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "newsInfo" ("id" SERIAL NOT NULL, "lang" character varying NOT NULL, "title" character varying NOT NULL, "shortDescription" character varying NOT NULL, "newsPostId" uuid, CONSTRAINT "PK_3834740a4719774fda43a3dd473" PRIMARY KEY ("id"))`,
    )
    ...
    await queryRunner.query(
      `ALTER TABLE "newsInfo" ADD CONSTRAINT "FK_2a2bc29f256b84568bb411ad5c4" FOREIGN KEY ("newsPostId") REFERENCES "news"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
  }

...
export class  $npmConfigName1710774675756 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "newsContent" ("id" SERIAL NOT NULL, "lang" character varying NOT NULL, "title" character varying NOT NULL, "shortDescription" character varying NOT NULL, "newsPostId" uuid, CONSTRAINT "PK_0b5eaa993309cc8002327462e02" PRIMARY KEY ("id"))`);
